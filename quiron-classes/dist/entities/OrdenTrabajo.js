...
var OrdenTrabajo = /** @class */ (function () {
    function OrdenTrabajo(_a) {
        var id = _a.id, equipo = _a.equipo, cliente = _a.cliente, servicio = _a.servicio, institucion = _a.institucion, formularios = _a.formularios;
        this.id = id ? id : "";
        ...
        this.institucion = institucion ? institucion : new index_1.Institucion({});
